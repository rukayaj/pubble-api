class DreamstimeService
  ...
  @@auth_token = ''
  attr_reader :thumbnail_url, :copyright

  def initialize(dst_image_id)
    response_obj = get_dst_image(dst_image_id)
    ...
    @thumbnail_url = image_object['ThumbnailUrl']
    @copyright = image_object['Author']
  end 
